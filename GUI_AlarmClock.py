...
def alarm(set_alarm_timer):
    while True:
        ...
        if now == set_alarm_timer:
            ...
            winsound.PlaySound("ringout.wav",winsound.SND_ASYNC)
            break
...
setYourAlarm = Label(clock,text="When to wake up",fg="blue",relief = "solid",font=("Helevetica",10,"bold")).place(x=0, y=29)
